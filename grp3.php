...
// $vars = 10;
for($i=2;$i<=$vars;$i++){
$sql .="(SELECT ".$i." AS var, sa.gridcode FROM humedad_".$i." sa WHERE sde.st_intersects(sde.st_point (".$lon.", ".$lat.", 4326), sa.shape))";
if ($i<$vars){ $sql .="UNION"; };
}	
$sql .="ORDER BY var;";
// echo $sql;		
...
<div id="container3" style="min-width: 310px; max-width: auto; height: 250px; margin: 0 auto"></div>
